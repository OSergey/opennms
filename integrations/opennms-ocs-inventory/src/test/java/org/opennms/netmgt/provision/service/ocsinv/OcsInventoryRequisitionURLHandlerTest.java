...
public class OcsInventoryRequisitionURLHandlerTest {
    ...
    public void testRequisitionImport() throws IOException {
        //URL ocsURL = new URL("ocsinv://dev:dev@192.168.56.101/foreignSource2?engine=groovy&checksum=35075");
        URL ocsURL = new URL("ocsinv://ocs-soap:ocsrockz@doku.informatik.hs-fulda.de/foreignSource2?engine=groovy&checksum=35075");
